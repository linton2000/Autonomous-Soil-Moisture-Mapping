function [out]=Hoperator_calc10(mc,day,grid)
...
R=evalin('base','OUTPUT1121.R');
[TAU10_1031]=AggregateTau(TAU1031,grid,R);
[TAU10_1107]=AggregateTau(TAU1107,grid,R);
[TAU10_1121]=AggregateTau(TAU1121,grid,R);
%------------------
% Options
%------------------
...
for j=1:4
     ...
     %  Determine domimant class 
      ...
      % SOILTYPE
              [sand,clay,rob]=getsoil40(lat(i),long(j),grid.refmat(1,2));  
